...
export type DoctorsStruct = Doctor & {
...
function DoctorsManagement() {
  ...
  const [selectedDoctor, setSelectedDoctor] = useState<DoctorsStruct | null>(
    null,
  );

  const handleEditDoctor = (doctor: DoctorsStruct) => {
      ...
      <Card className="mb-12">
        ...
        <CardContent>
          <div className="space-y-4">
            {doctors.map((doctor: DoctorsStruct) => (
              <div
                key={doctor.id}
