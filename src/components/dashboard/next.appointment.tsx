...
import NoNextAppointments from "./no.next.appointment";
...
async function NextAppointment() {
  ...
  const upcomingAppointments =
    appointments?.filter((appointment) => {
      const appointmentDate = parseISO(appointment.date.toISOString());
  ...
  const appointmentDate = parseISO(nextAppointment.date.toISOString());
